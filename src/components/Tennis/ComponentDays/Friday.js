...
export default class Monday extends React.Component {
    render() {
        ...
        const gym2 = new OpenGymInst(StJohnsRacquetCenter, "St. Johns Racquet Center", "7519 N Burlington Ave, Portland, OR 97203", "https://goo.gl/maps/d7WVkBReSGAJVeb4A", "Tennis", "Friday through Sunday", "8:00am to 10:00pm", "$30.00 per Court 75 minutes", "Singles/Doubles", "https://www.stjohnsracquetcenter.org/", "Courts can be booked up to 7 days in advance.", "8", "Indoor", "None");
        const gym3 = new OpenGymInst(LakeOswegoTennisCenter, "Lake Oswego Tennis Center", "2900 SW Diane Dr, Lake Oswego, OR 97035", "https://goo.gl/maps/3QUUnJDZjpMpqtF17", "Tennis", "Everyday", "6:00am to 10:00pm", "$22.00 per Court 60 minutes", "Singles/Doubles", "https://www.ci.oswego.or.us/parksrec/indoor-tennis-center", "Courts can be booked up to 7 days in advance.", "8", "Indoor", "None");
