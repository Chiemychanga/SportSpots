...
export default class Monday extends React.Component {
    render() {
        ...
        const gym1 = new OpenGymInst(StJohnsRacquetCenter, "St. Johns Racquet Center", "7519 N Burlington Ave, Portland, OR 97203", "https://goo.gl/maps/d7WVkBReSGAJVeb4A", "Tennis", "Monday and Thursday", "8:00am to 2:00pm and 6:00pm to 10:00pm", "$30.00 per Court 75 minutes", "Singles/Doubles", "https://www.stjohnsracquetcenter.org/", "Courts can be booked up to 7 days in advance.", "8", "Indoor", "None");
        const gym2 = new OpenGymInst(LakeOswegoTennisCenter, "Lake Oswego Tennis Center", "2900 SW Diane Dr, Lake Oswego, OR 97035", "https://goo.gl/maps/3QUUnJDZjpMpqtF17", "Tennis", "Monday and Thursday", "6:00am to 10:00pm", "$22.00 per Court 60 minutes", "Singles/Doubles", "https://www.ci.oswego.or.us/parksrec/indoor-tennis-center", "Courts can be booked up to 7 days in advance.", "8", "Indoor", "None");
        const gyms = [gym1,gym2];
        return (
            <div className="gym-spots">
                <h1>Tennis Spots Tuesday</h1>
