                ...
                <div className="form-body">
                    ...
                    <form id="contact-form" onSubmit={this.handleSubmit.bind(this)} method="POST">
                        ...
                        <div className="form-group-row">
                            ...
                            <label className="col-sm-2" id="sport-select-tag">Basketball</label>
                            ...
                            <label className="col-sm-2" id="sport-select-tag">Tennis</label>
                        ...
                        <div className="form-group-row">
                            <label htmlFor="days-of-week" className="col-sm-2" id="days-of-week-open-tag">Days Of The Week Open</label>
                            <input type="text" className="col-sm-10" value={this.state.dayOfWeek} onChange={this.onDayOfWeekChange.bind(this)}/>
                        </div>

                        <div className="form-group-row">
                            <label htmlFor="time" className="col-sm-2" id="time-tag">Time Gym Open</label>
                            <input type="text" className="col-sm-2" value={this.state.time} onChange={this.onTimeChange.bind(this)}/>

                            <label htmlFor="cost" className="col-sm-2" id="cost-tag">Cost Per Session</label>
                            <input type="text" className="col-sm-2" value={this.state.cost} onChange={this.onCostChange.bind(this)}/>

                            <label htmlFor="website" className="col-sm-2" id="website-tag">Website Link</label>
                            <input type="text" className="col-sm-2" value={this.state.website} onChange={this.onWebsiteChange.bind(this)}/>
                        </div>

                        <div className="form-group">
                            <label htmlFor="level-description" id="level-description-tag">Level Description</label>
                        ...
                        <div className="form-group">
                            <label htmlFor="description" id="description-tag">Description</label>
                            <textarea className="form-control" value={this.state.description} onChange={this.onDescriptionChange.bind(this)}/>
                        </div>

                        <div className="form-group-row">
                            <label htmlFor="number-of-courts" className="col-sm-2" id="number-of-courts-tag" >Number Of Courts</label>
                            ...
                            <label htmlFor="court-type" className="col-sm-2" id="court-type-tag">Court Type</label>
                            ...
                            <label htmlFor="min-age" className="col-sm-2" id="minimum-age-tag">Minimum Age</label>
