...
const gyms = [
    //Sunday gyms
        new OpenGymInst(
          TualatinHillsAthleticCenter, 
          "Tualatin Hills Athletic Center",
          "50 NW 158th Ave, Beaverton, OR 97006", 
          "https://goo.gl/maps/xS2V7opznhbrRKCG9", 
          "Volleyball", 
          "Sunday and Saturday", 
          "7:00pm to 9:45pm",
          "$5, $6.25 (out of district)",
          "Open",
          "http://www.thprd.org/schedules/schedule.cfm?cs_id=28",
          "No pre-registration required on Saturdays. 42 players max limit.",
          "3",
          "Indoor",
          "18"
          ),
        new OpenGymInst(
          ...
          "https://goo.gl/maps/45ZLWS7ZdRrA17Er8",
          "Volleyball",
          "Saturday",
          "12:00pm to 2:00pm",
          "$6 (Seniors: $4.75, Teens: $4.75)",
          "Open",
          "http://www.portlandoregon.gov/parks/60409",
          "Saturday starts at 12:15pm and runs to 1:45pm.",
          "2",
          "Indoor",
          "13"
          ),
        new OpenGymInst(
          ...
          "https://goo.gl/maps/26BrMpZBaw1BJJjC8",
          "Volleyball",
          "Sunday",
          "6:00pm to 7:55pm",
          "$6.25 (out of district)",
          "Open",
          "http://www.thprd.org/facilities/recreation/conestoga/schedule/dropinsports/#dropin",
          "Drop-in tickets available at 5:15pm. Check-in starts at 5:45pm. Play at 6:00pm. They let in 32 players, then a wait list.",
          "2",
          "Indoor",
          "16"
          ),
